    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme"
            ...
            <div class="app-brand demo">
                <a href="https://store-buddy.webential.com/public" class="app-brand-link">
                    ...
                    <span class="app-brand-text demo menu-text fw-bold ms-2">Store Buddy</span>
                </a>
            ...
            <ul class="menu-inner py-1 ps">
                ...
                @if(auth()->user()->hasRole('company') || auth()->user()->hasRole('super_admin'))
                <li class="menu-item {{ request()->routeIs('app-user-list') ? 'active' : '' }}">
                    <a href="{{ route('app-user-list') }}" class="menu-link">
                        <i class="menu-icon icon-base bx bx-user"></i>
                        <div> @if (auth()->user()->hasRole('super_admin')) SB @endif Staff</div>
                    </a>
                </li>
