                ...
                <div id="personal-details" class="content">
                    <div class="row g-6">
                        ...
                        <div class="col-sm-6 form-control-validation">
                            ...
                            <input type="text" class="form-control" id="add-user-fname" name="fname" placeholder="John" value="{{ (isset($company->first_name)) ? $company->first_name : old('fname') }}" required />
                        </div>
                        <div class="col-sm-6 form-control-validation">
                            <label class="form-label" for="add-user-lname">Last Name</label>
                            <input type="text" class="form-control" id="add-user-lname" name="lname" placeholder="Doe" value="{{ (isset($company->last_name)) ? $company->last_name : old('lname') }}" required />
                        </div>
                        <div class="col-sm-6 form-control-validation">
                            <label class="form-label" for="add-user-email">Email</label>
                            <input type="email" id="add-user-email" class="form-control" name="email" placeholder="john.doe@example.com" value="{{ (isset($company->email)) ? $company->email : old('email') }}" required />
                        </div>
                        <div class="col-sm-6 form-password-toggle form-control-validation">
                            <label class="form-label" for="add-user-password">Password</label>
                            <div class="input-group input-group-merge">
                                <input type="password" id="add-user-password" class="form-control" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="passwordToggler"/>
                        ...
                        <div class="col-sm-6 form-password-toggle form-control-validation">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" id="add-user-password_confirmation" class="form-control" name="password_confirmation" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="passwordToggler"/>
                                <span id="passwordToggler" class="input-group-text cursor-pointer"><i class="icon-base bx bx-hide"></i></span>
                            </div>
                            @if (!empty($company->id))
                                <small class="text-muted">Leave blank to keep existing password (on edit).</small>                                
                ...
                <div id="company-details" class="content">
                    <div class="row">
                        <div class="form-control-validation mb-3">
                            ...
                            <input type="text" class="form-control" id="add-company-fullname" name="companyname" placeholder="Company Name" value="{{ (isset($company->name)) ? $company->name : old('companyname') }}" />                            
                        </div>
                        <div class="form-control-validation mb-3">
                            <label class="form-label" for="add-trading-name">Trading Name</label>
                            <input type="text" class="form-control" id="add-trading-name" name="tradingname" placeholder="Trading Name" value="{{ (isset($company->trading_name)) ? $company->trading_name : old('tradingname') }}" />
                        </div>
                        <div class="form-control-validation mb-3">
                            <label class="form-label" for="add-phone">Phone</label>
                            <input type="text" id="add-phone" name="phone" class="form-control contact-number-mask" placeholder="202 555 0111" value="{{ (isset($company->phone)) ? $company->phone : old('phone') }}" />
                        </div>
                        ...
                        <div class="col-lg-6 form-control-validation">
                            ...
                            <input type="text" name="billing_address" id="billing-address" class="form-control" placeholder="Street address" value="{{ old('billing_address', $company->billing_address ?? null) }}">
                        </div>

                        <div class="col-lg-6 form-control-validation">
                            <label class="form-label" for="billing-state">State</label>
                            <input type="text" name="billing_state" id="billing-state" class="form-control" placeholder="State" value="{{ old('billing_state', $company->billing_state ?? null) }}">
                        </div>

                        <div class="col-lg-6 form-control-validation">
                            <label class="form-label" for="billing-suburb">Suburb</label>
                            <input type="text" name="billing_suburb" id="billing-suburb" class="form-control" placeholder="NSW" value="{{ old('billing_suburb', $company->billing_suburb ?? null) }}">
                        </div>

                        <div class="col-lg-6 form-control-validation mb-3">
                            <label class="form-label" for="billing-postcode">Post Code</label>
                            <input type="text" name="billing_postcode" id="billing-postcode" class="form-control" placeholder="2000" value="{{ old('billing_postcode', $company->billing_postcode ?? null) }}">
                        </div>
                        ...
                        <div class="col-lg-6 form-control-validation">
                            ...
                            <input type="text" name="delivery_address" id="delivery-address" class="form-control" placeholder="Street address" value="{{ old('delivery_address', $company->delivery_address ?? null) }}">
                        </div>

                        <div class="col-lg-6 form-control-validation">
                            <label class="form-label" for="delivery-state">State</label>
                            <input type="text" name="delivery_state" id="delivery-state" class="form-control" placeholder="State" value="{{ old('delivery_state', $company->delivery_state ?? null) }}">
                        </div>

                        <div class="col-lg-6 form-control-validation">
                            <label class="form-label" for="delivery-suburb">Suburb</label>
                            <input type="text" name="delivery_suburb" id="delivery-suburb" class="form-control" placeholder="NSW" value="{{ old('delivery_suburb', $company->delivery_suburb ?? null) }}">
                        </div>

                        <div class="col-lg-6 form-control-validation mb-3">
                            <label class="form-label" for="delivery-postcode">Post Code</label>
                            <input type="text" name="delivery_postcode" id="delivery-postcode" class="form-control" placeholder="2000" value="{{ old('delivery_postcode', $company->delivery_postcode ?? null) }}">
                        </div>
                        <div class="col-12 d-flex justify-content-between">
                ...
                <div id="other-details" class="content">
                    <div class="row g-6">
                        <div class="col-sm-6 form-control-validation">
                            ...
                            <input type="url" id="website-url" name="websiteurl" class="form-control" placeholder="https://example.com" value="{{ (isset($company->website_url)) ? $company->website_url : old('websiteurl') }}" />
                        </div>
                        <div class="col-sm-6 form-control-validation">
                            <label class="form-label" for="abn-acn">ABN/ACN</label>
                            <input type="text" id="abn-acn" name="abnacn" class="form-control" placeholder="202 555 0111" value="{{ (isset($company->abn_acn)) ? $company->abn_acn : old('abnacn') }}" />
                        </div>
                        <div class="col-sm-6 form-control-validation">
                            ...
                            <select id="add-company-platform" name="platform" class="form-select">
                                ...
                                <option value="storman" {{ (isset($company->platform) && $company->platform == "storman") ? 'selected' : '' }}>Storman</option>
                            </select>
                        </div>
                        <div class="col-sm-6 form-control-validation">
                            ...
                            <select id="plan" name="plan" class="form-select">
                                ...
                                <option value="basic" {{ (isset($company->plan) && $company->plan == "basic") ? 'selected' : '' }}>Basic</option>
                                <option value="advance" {{ (isset($company->plan) && $company->plan == "advance") ? 'selected' : '' }}>Advance</option>
                            </select>
                        </div>
                        <div class="col-sm-6 form-control-validation">
