...
@section('title', 'Storage Provider Settings')
...
@section('content')
    <div class="card mb-6">
        <h5 class="card-header">Storage Provider Settings</h5>
        <div class="card-body pt-1">
            <form id="formStormanSettings">
                @csrf
                <div class="mb-6 fv-row">
                    <label class="form-label" for="api_url">Storage Provider API URL</label>
                    <input type="text" class="form-control" id="api_url" name="api_url" value="{{ old('api_url', $company?->storman_api_url ?? '') }}" required>
                </div>

                <div class="mb-6 fv-row">
                    <label class="form-label" for="token">Storage Provider API Token</label>
