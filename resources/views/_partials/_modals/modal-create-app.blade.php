          ...
          <div class="bs-stepper-content p-1 pb-0">
            <form onSubmit="return false">
              ...
              <div id="details" class="content pt-4 pt-lg-0">
                ...
                <ul class="p-0 m-0">
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-info p-2 me-3 rounded"><i class="icon-base bx bx-file icon-30px"></i>
                    </div>
                  ...
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-success p-2 me-3 rounded"><i class="icon-base bx bx-cart icon-30px"></i>
                    </div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-start">
                    <div class="badge bg-label-danger p-2 me-3 rounded"><i
                        class="icon-base bx bx-laptop icon-30px"></i></div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                ...
                <div class="col-12 d-flex justify-content-between mt-6">
                  ...
                  <button class="btn btn-primary btn-next"><span
                      ...
                      class="icon-base bx bx-right-arrow-alt icon-sm"></i></button>
                </div>
              </div>
              ...
              <div id="frameworks" class="content pt-4 pt-lg-0">
                ...
                <ul class="p-0 m-0">
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-info p-2 me-3 rounded"><i class="icon-base bx bxl-react icon-30px"></i>
                    </div>
                  ...
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-danger p-2 me-3 rounded">
                      <i class="icon-base bx bxl-angular icon-30px"></i>
                    </div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-success p-2 me-3 rounded"><i
                        class="icon-base bx bxl-vuejs icon-30px"></i></div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-start">
                    <div class="badge bg-label-warning p-2 me-3 rounded"><i
                        class="icon-base bx bxl-html5 icon-30px"></i></div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                ...
                <div class="col-12 d-flex justify-content-between mt-6">
                  <button class="btn btn-label-secondary btn-prev"><i
                      class="icon-base bx bx-left-arrow-alt icon-sm me-sm-2 me-0"></i> <span
              ...
              <div id="database" class="content pt-4 pt-lg-0">
                ...
                <ul class="p-0 m-0">
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-danger p-2 me-3 rounded"><i
                        class="icon-base bx bxl-firebase icon-30px"></i></div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-warning p-2 me-3 rounded"><i
                        class="icon-base bx bxl-amazon icon-30px"></i></div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-start">
                    <div class="badge bg-label-info p-2 me-3 rounded"><i class="icon-base bx bx-data icon-30px"></i>
                    </div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                ...
                <div id="AppNewCCForm" class="row g-6 mb-6" onsubmit="return false">
                  <div class="col-12">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <span class="input-group-text cursor-pointer" id="modalAppAddCard"><span
                  ...
                  <div class="col-6 col-md-3">
                    ...
                    <div class="input-group input-group-merge">
                      <input type="text" id="modalAppAddCardCvv" class="form-control app-cvv-code-mask pe-0"
                        maxlength="3" placeholder="654" />
                      <span class="input-group-text cursor-pointer" id="modalAppAddCardCvv2"><i
                          class="text-body-secondary icon-base bx bx-help-circle" data-bs-toggle="tooltip"
              ...
              <div id="submit" class="content text-center pt-4 pt-lg-0">
                ...
                <!-- image -->
                <img src="{{ asset('assets/img/illustrations/man-with-laptop.png') }}" alt="Create App img"
                  width="163" class="img-fluid" />
                <div class="col-12 d-flex justify-content-between mt-6">
                  <button class="btn btn-label-secondary btn-prev"><i
                      class="icon-base bx bx-left-arrow-alt icon-sm me-sm-2 me-0"></i> <span
                      class="align-middle d-sm-inline-block d-none">Previous</span></button>
