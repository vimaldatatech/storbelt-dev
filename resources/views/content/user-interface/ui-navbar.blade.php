                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="javascript:void(0)"><i
                          class="icon-base bx bx-envelope"></i> Email</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="javascript:void(0)"><i
                          class="icon-base bx bx-chat"></i> Chat</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="javascript:void(0)"><i
                          class="icon-base bx bx-task"></i> ToDos</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="javascript:void(0)"><i
                          class="icon-base bx bx-calendar"></i> Calender</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link disabled" href="javascript:void(0)" tabindex="-1"><i
                          class="icon-base bx bx-block"></i> Disabled</a>
                    </li>
                  </ul>
                </div>
                <div class="col-sm-6 col-lg p-4">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar-ex-7">
        ...
        <ul class="navbar-nav ms-lg-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="javascript:void(0);"><i class="icon-base navbar-icon bx bx-lock-open-alt"></i>
              Logout</a>
          </li>
        </ul>
      </div>
