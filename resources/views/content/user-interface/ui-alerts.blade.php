    ...
    <div class="col-md">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="alert alert-outline-secondary" role="alert">This is a secondary outline alert — check it out!
          </div>
        ...
        <div class="card-body">
          ...
          <div class="alert alert-success alert-dismissible" role="alert">
            ...
            <p class="mb-0">Halvah cheesecake toffee. Cupcake jelly cookie chocolate bar topping. Cupcake candy dessert
              biscuit chocolate halvah bear claw sweet liquorice. Gummies wafer candy canes chocolate.</p>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
          <div class="alert alert-danger alert-dismissible" role="alert">
            <h4 class="alert-heading d-flex align-items-center flex-wrap gap-1">
          ...
          <div class="alert alert-primary alert-dismissible mb-0" role="alert">
            ...
            <p class="mb-0">Bonbon sweet roll dragée lemon drops tart gummi bears fruitcake. Jujubes bonbon danish
              dragée oat cake cupcake macaroon. Sesame snaps pudding cotton candy.</p>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
        </div>
      </div>
