  ...
  <div class="row g-6">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <p class="card-text">Toggle the visibility of content across your project with a few classes and our JavaScript
            plugins.</p>
          ...
          <div class="collapse" id="collapseExample">
            <div class="d-grid d-sm-flex p-4 border">
              <img src="{{ asset('assets/img/elements/1.png') }}" alt="collapse-image" height="125"
        ...
        <div class="card-body">
          ...
          <div style="min-height: 120px;">
            <div class="collapse-horizontal collapse show" id="collapseWidthExample">
              <div class="p-4 border" style="width: 300px;">Lorem Ipsum is simply dummy text of the printing and
                typesetting industry Ipsum has been the.</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="demo-inline-spacing">
            <a class="btn btn-primary me-1" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button"
          ...
          <div class="row">
            <div class="col-12 col-md-6 mb-2 mb-md-0">
              <div class="collapse multi-collapse" id="multiCollapseExample1">
                <div class="d-grid d-sm-flex p-4 border">
                  <img src="{{ asset('assets/img/elements/2.png') }}" alt="collapse-image" height="125"
                    class="me-6 mb-sm-0 mb-2" />
                  <span> All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary,
            ...
            <div class="col-12 col-md-6">
              <div class="collapse multi-collapse" id="multiCollapseExample2">
                <div class="d-grid d-sm-flex p-4 border">
                  <img src="{{ asset('assets/img/elements/3.png') }}" alt="collapse-image" height="125"
                    class="me-6 mb-sm-0 mb-2" />
