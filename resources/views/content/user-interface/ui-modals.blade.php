                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <div class="onboarding-media">
                            <div class="mx-2">
                              <img
                                src="{{ asset('assets/img/illustrations/girl-with-laptop-' . $configData['theme'] . '.png') }}"
                        ...
                        <div class="carousel-item">
                          <div class="onboarding-media">
                            <div class="mx-2">
                              <img
                                src="{{ asset('assets/img/illustrations/boy-with-laptop-' . $configData['theme'] . '.png') }}"
                        ...
                        <div class="carousel-item">
                          <div class="onboarding-media">
                            <div class="mx-2">
                              <img
                                src="{{ asset('assets/img/illustrations/girl-verify-password-' . $configData['theme'] . '.png') }}"
                  ...
                  <div class="modal-content text-center">
                    ...
                    <div class="modal-body p-0">
                      <div class="onboarding-media">
                        <div class="mx-2">
                          <img
                            src="{{ asset('assets/img/illustrations/girl-unlock-password-' . $configData['theme'] . '.png') }}"
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <div class="onboarding-horizontal">
                            <div class="onboarding-media">
                              <img
                                src="{{ asset('assets/img/illustrations/boy-with-rocket-' . $configData['theme'] . '.png') }}"
                        ...
                        <div class="carousel-item">
                          <div class="onboarding-horizontal">
                            <div class="onboarding-media">
                              <img
                                src="{{ asset('assets/img/illustrations/girl-doing-yoga-' . $configData['theme'] . '.png') }}"
                                alt="boy-with-rocket-light" width="273" class="img-fluid"
                ...
                <div class="modal-dialog modal-xl" role="document">
                  <div class="modal-content text-center">
                    ...
                    <div class="modal-body onboarding-horizontal p-0">
                      <div class="onboarding-media">
                        <img
                          src="{{ asset('assets/img/illustrations/boy-verify-email-' . $configData['theme'] . '.png') }}"
