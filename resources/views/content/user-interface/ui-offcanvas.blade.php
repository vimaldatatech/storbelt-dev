      ...
      <div class="card">
        <div class="card-body">
          ...
          <div>
            ...
            <div class="offcanvas offcanvas-start offcanvas-xl" tabindex="-1" id="offcanvasResponsive"
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div>
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasDark"
              aria-labelledby="offcanvasDarkLabel" data-bs-theme="dark">
              <div class="offcanvas-header">
