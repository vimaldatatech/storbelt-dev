          ...
          <div class="row g-6">
                ...
                <div class="col-md mb-md-0">
                  <div class="form-check custom-option custom-option-icon">
                    <label class="form-check-label custom-option-content" for="customRadioOwner">
                      ...
                      <input name="plUserType" class="form-check-input" type="radio" value="2"
                        id="customRadioOwner" />
                    </label>
                  </div>
                </div>
                <div class="col-md mb-md-0">
                  <div class="form-check custom-option custom-option-icon">
                    <label class="form-check-label custom-option-content" for="customRadioBroker">
                      ...
                      <input name="plUserType" class="form-check-input" type="radio" value="3"
            ...
            <div class="col-sm-6">
              ...
              <div class="input-group input-group-merge">
                ...
                <input type="text" id="plContact" name="plContact" class="form-control contact-number-mask"
            ...
            <div class="col-12 d-flex justify-content-between">
              ...
              <button class="btn btn-primary btn-next"><span
                  ...
                  class="icon-base bx bx-right-arrow-alt icon-sm scaleX-n1-rtl"></i></button>
            </div>
          </div>
        </div>
          ...
          <div class="row g-6">
                ...
                <div class="col-sm mb-sm-0 mb-6">
                  <div class="form-check custom-option custom-option-icon">
                    <label class="form-check-label custom-option-content" for="customRadioSell">
                      ...
                      <input name="plPropertySaleRent" class="form-check-input" type="radio" value="1"
                        id="customRadioSell" checked />
                    </label>
                  </div>
                </div>
                <div class="col-sm">
                  <div class="form-check custom-option custom-option-icon">
                    <label class="form-check-label custom-option-content" for="customRadioRent">
                      ...
                      <input name="plPropertySaleRent" class="form-check-input" type="radio" value="2"
                        id="customRadioRent" />
                    </label>
                  </div>
                </div>
            ...
            <div class="col-12 d-flex justify-content-between">
              <button class="btn btn-label-secondary btn-prev"><i
                  class="icon-base bx bx-left-arrow-alt scaleX-n1-rtl icon-sm me-sm-2 me-0"></i> <span
                  class="align-middle d-sm-inline-block d-none">Previous</span></button>
              <button class="btn btn-primary btn-next"><span
                  class="align-middle d-sm-inline-block d-none me-sm-2">Next</span> <i
                  class="icon-base bx bx-right-arrow-alt scaleX-n1-rtl icon-sm"></i></button>
            </div>
          </div>
        </div>
          ...
          <div class="row g-6">
            ...
            <div class="col-sm-6 form-control-validation">
              ...
              <div class="form-check my-2 ms-2">
                <input class="form-check-input" type="radio" name="plCommonAreaRadio" id="plCommonAreaRadioYes"
                  checked />
        ...
        <div id="property-area" class="content">
          <div class="row g-6">
            <div class="col-sm-6 form-control-validation">
              ...
              <div class="input-group input-group-merge">
                <input type="number" class="form-control" id="plTotalArea" name="plTotalArea" placeholder="1000"
            ...
            <div class="col-sm-6 form-control-validation">
              ...
              <div class="input-group input-group-merge">
                <input type="number" class="form-control" id="plCarpetArea" name="plCarpetArea" placeholder="800"
            ...
            <div class="col-sm-6 form-control-validation">
              ...
              <div class="input-group input-group-merge">
                <input type="number" class="form-control" id="plPlotArea" name="plPlotArea" placeholder="800"
            ...
            <div class="col-sm-6 form-control-validation">
              ...
              <input type="text" id="plAvailableFrom" name="plAvailableFrom" class="form-control flatpickr"
                placeholder="YYYY-MM-DD" />
            </div>
            <div class="col-sm-6 form-control-validation">
              <p class="mb-2">Possession Status</p>
              <div class="form-check my-2 ms-2">
                <input class="form-check-input" type="radio" name="plPossessionStatus" id="plUnderConstruction"
                  checked />
            ...
            <div class="col-sm-6 form-control-validation">
              ...
              <div class="form-check my-2 ms-2">
                <input class="form-check-input" type="radio" name="plRoadFacingRadio" id="plRoadFacingRadioYes"
                  checked />
            ...
            <div class="col-sm-6 form-control-validation">
              ...
              <div class="form-check my-2 ms-2">
                <input class="form-check-input" type="radio" name="plGatedColonyRadio" id="plGatedColonyRadioYes"
                  checked />
        ...
        <div id="price-details" class="content">
          <div class="row g-6">
            ...
            <div class="col-sm-6">
              ...
              <div class="input-group input-group-merge">
                <input type="number" class="form-control" id="plPriceSqft" name="plPriceSqft" placeholder="500"
            ...
            <div class="col-sm-6">
              ...
              <div class="input-group input-group-merge">
                <input type="number" class="form-control" id="plOtherAmount" name="plOtherAmount" placeholder="500"
