    ...
    <div class="col-xl-8 col-lg-7 order-0 order-md-1">
      ...
      <div class="nav-align-top">
        <ul class="nav nav-pills flex-column flex-md-row mb-6 flex-wrap row-gap-2">
          <li class="nav-item">
            <a class="nav-link" href="{{ url('app/user/view/account') }}"><i
      ...
      <div class="card mb-6">
        ...
        <div class="card-body pt-0">
          ...
          <div class="d-flex mb-4 align-items-center">
            <div class="flex-shrink-0">
              <img src="{{ asset('assets/img/icons/brands/twitter-' . $configData['theme'] . '.png') }}" alt="twitter"
                class="me-4" height="36" data-app-dark-img="icons/brands/twitter-dark.png"
                data-app-light-img="icons/brands/twitter-light.png" />
            </div>
            <div class="flex-grow-1 row align-items-center me-n1">
              <div class="col-7 mb-sm-0 mb-2">
                <h6 class="mb-1">Twitter</h6>
                <a href="{{ config('variables.twitterUrl') }}" class="small" target="_blank">
          ...
          <div class="d-flex mb-4 align-items-center">
            <div class="flex-shrink-0">
              <img src="{{ asset('assets/img/icons/brands/linkedin.png') }}" alt="linkedin" class="me-4"
                height="36" />
            </div>
            <div class="flex-grow-1 row align-items-center me-n1">
              <div class="col-7 mb-sm-0 mb-2">
                <h6 class="mb-1">linkedin</h6>
                <a href="{{ config('variables.instagramUrl') }}" class="small" target="_blank">
                  {{ '@' . config('variables.creatorName') }}
                </a>
              </div>
              <div class="col-5 text-end">
