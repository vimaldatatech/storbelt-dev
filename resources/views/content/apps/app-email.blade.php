      ...
      <div class="card shadow-none border-0 rounded-0">
        <div class="card-body emails-list-header p-3 py-2">
          ...
          <div class="d-flex justify-content-between align-items-center px-3 mt-2">
            <div class="d-flex align-items-center w-100">
              <i class="icon-base bx bx-menu icon-lg cursor-pointer d-block d-lg-none me-4 mb-4"
          ...
          <div class="d-flex justify-content-between align-items-center ps-1">
            <div class="d-flex align-items-center">
              ...
              <div class="btn btn-icon btn-text-secondary rounded-pill me-1"><i
                  class="icon-base bx bx-trash icon-md email-list-delete cursor-pointer"></i></div>
        ...
        <div class="email-list pt-0">
          <ul class="list-unstyled m-0">
            <li class="email-list-item email-marked-read d-flex align-items-center" data-starred="true"
              ...
              <div class="d-flex align-items-center w-100">
                ...
                <span class="ms-sm-3 me-4 d-sm-inline-block d-none"><i
                    class="email-list-item-bookmark icon-base bx bx-star icon-md cursor-pointer ms-1"></i></span>
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <small class="email-list-item-subject d-xl-inline-block d-block"> Focused impactful open issues from
                    the project of GitHub</small>
                </div>
            ...
            <li class="email-list-item email-marked-read d-flex align-items-center" data-sent="true"
              ...
              <div class="d-flex align-items-center w-100">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <small class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, Dessert soufflé tootsie
                    roll soufflé carrot cake halvah jelly.</small>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
            ...
            <li class="email-list-item email-marked-read d-flex align-items-center" data-draft="true"
              ...
              <div class="d-flex align-items-center w-100">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <small class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, Soufflé apple pie caramels
                    soufflé tiramisu bear claw.</small>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  <span
                    class="email-list-item-attachment icon-base bx bx-paperclip icon-md cursor-pointer me-2 float-end float-sm-none"></span>
                  <span class="email-list-item-label badge badge-dot bg-primary d-none d-md-inline-block me-2"
            ...
            <li class="email-list-item d-flex align-items-center" data-starred="true" data-bs-toggle="sidebar"
              ...
              <div class="d-flex align-items-center w-100">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <small class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, Tart croissant jujubes
                    gummies macaroon Icing sweet.</small>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  ...
                  <ul class="list-inline email-list-item-actions">
                    <li class="list-inline-item email-delete btn btn-icon btn-text-secondary rounded-pill"><i
                        class="icon-base bx bx-trash icon-md"></i></li>
                    <li class="list-inline-item email-read btn btn-icon btn-text-secondary rounded-pill"><i
                        class="icon-base bx bx-envelope-open icon-md"></i></li>
                    <li class="list-inline-item btn btn-icon btn-text-secondary rounded-pill"><i
                        class="icon-base bx bx-info-circle icon-md"></i></li>
                  </ul>
                </div>
            ...
            <li class="email-list-item email-marked-read d-flex align-items-center" data-spam="true"
              ...
              <div class="d-flex align-items-center w-100">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <small class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, I love Pudding cookie
                    chocolate sweet tiramisu jujubes I love danish.</small>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  <span class="email-list-item-label badge-dot bg-danger d-none d-md-inline-block me-2"
                    data-label="company"></span>
                  <small class="email-list-item-time text-body-secondary">Yesterday</small>
                  <ul class="list-inline email-list-item-actions">
                    <li class="list-inline-item email-delete btn btn-icon btn-text-secondary rounded-pill"><i
            ...
            <li class="email-list-item d-flex align-items-center" data-trash="true" data-bs-toggle="sidebar"
              data-target="#app-email-view">
              <div class="d-flex align-items-center w-100">
                <div class="form-check mb-0 ms-2">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <small class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, I love danish. Cupcake I
                    love carrot cake sugar plum I love.</small>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  <span class="email-list-item-label badge badge-dot bg-primary d-none d-md-inline-block me-2"
                    data-label="work"></span>
            ...
            <li class="email-list-item email-marked-read d-flex align-items-center" data-draft="true"
              ...
              <div class="d-flex align-items-center w-100">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <small class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, Chocolate cake pudding
                    chocolate bar ice cream bonbon lollipop.</small>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
            ...
            <li class="email-list-item email-marked-read d-flex align-items-center" data-starred="true"
              ...
              <div class="d-flex align-items-center w-100">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <small class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, Icing gummi bears ice
                    cream croissant dessert wafer.</small>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  <span
                    class="email-list-item-attachment icon-base bx bx-paperclip icon-md cursor-pointer me-2 float-end float-sm-none"></span>
            ...
            <li class="email-list-item email-marked-read d-flex align-items-center" data-spam="true"
              ...
              <div class="d-flex align-items-center w-100">
                ...
                <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                  ...
                  <small class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, Chocolate cake pudding
                    chocolate bar ice cream Sweet.</small>
                </div>
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  <span class="email-list-item-label badge badge-dot bg-primary d-none d-md-inline-block me-2"
                    data-label="important"></span>
      ...
      <div class="card shadow-none border-0 rounded-0 app-email-view-header p-5 pt-md-4 py-2">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <div class="d-flex align-items-center overflow-hidden">
            <span class="ms-sm-2 me-4"><i class="icon-base bx bx-chevron-left icon-md cursor-pointer  scaleX-n1-rtl"
          ...
          <div class="d-flex align-items-center">
            <span class="btn btn-icon btn-text-secondary rounded-pill p-0 me-2 disabled">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <div class="d-flex align-items-center">
            <span class="btn btn-icon btn-text-secondary rounded-pill me-1"><i
                class="icon-base bx bx-trash icon-md cursor-pointer"></i></span>
            <span class="btn btn-icon btn-text-secondary rounded-pill me-1"><i
                class="icon-base bx bx-envelope-open icon-md cursor-pointer" data-bs-toggle="sidebar"
          ...
          <div class="card-header d-flex justify-content-between align-items-center flex-wrap border-bottom">
            ...
            <div class="d-flex align-items-center">
              ...
              <span class="btn btn-icon btn-text-secondary rounded-pill"><i
                  class="icon-base bx bx-paperclip icon-md cursor-pointer"></i></span>
              <span class="btn btn-icon btn-text-secondary rounded-pill"><i
                  class="icon-base bx bx-star icon-md cursor-pointer"></i></span>
              <div class="dropdown">
          ...
          <div class="card-body pt-0 ps-4">
            ...
            <div class="d-flex justify-content-end align-items-center mt-4">
              <div class="cursor-pointer btn btn-text-secondary text-secondary me-4">
                <i class="icon-base bx bx-paperclip icon-16px text-heading me-2"></i>
    ...
    <div class="modal-dialog m-0 me-md-6 mb-6 modal-lg">
      <div class="modal-content p-0">
        <div class="modal-header py-3 justify-content-between">
          <h5 class="modal-title text-body">Compose Mail</h5>
          <div class="d-flex align-items-center gap-2">
            <button type="button" class="btn btn-icon btn-text-secondary rounded-pill"><i
                class="icon-base bx bx-minus"></i></button>
            <button type="button" class="btn btn-icon btn-text-secondary rounded-pill" data-bs-dismiss="modal"
              aria-label="Close"><i class="icon-base bx bx-x"></i></button>
          </div>
        </div>
          ...
          <form class="email-compose-form">
            ...
            <div class="email-compose-actions d-flex justify-content-between align-items-center my-4">
              <div class="d-flex align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-primary dropdown-toggle email-send-btn" data-bs-toggle="dropdown"
                    aria-expanded="false">Send <i
                      class="icon-base bx bx-paper-plane icon-sm scaleX-n1-rtl ms-2"></i></button>
                ...
                <label for="attach-file" class="btn btn-icon btn-text-secondary rounded-pill ms-4"><i
                    class="icon-base bx bx-paperclip cursor-pointer"></i></label>
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <button type="reset" class="btn btn-icon btn-text-secondary rounded-pill" data-bs-dismiss="modal"
                  aria-label="Close"><i class="icon-base bx bx-trash"></i></button>
              </div>
            </div>
          </form>
        </div>
