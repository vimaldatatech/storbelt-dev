    ...
    <div class="card p-0 mb-6">
      <div class="card-body d-flex flex-column flex-md-row justify-content-between p-0 pt-6">
        <div class="app-academy-md-25 card-body py-0 pt-6 ps-12">
          <img src="{{ asset('assets/img/illustrations/bulb-' . $configData['theme'] . '.png') }}"
        ...
        <div class="app-academy-md-50 card-body d-flex align-items-md-center flex-column text-md-center mb-6 py-6">
          ...
          <p class="mb-4">Grow your skill with the most reliable online courses and certifications in<br />marketing,
          ...
          <div class="d-flex align-items-center justify-content-between app-academy-md-80">
            ...
            <button type="submit" class="btn btn-primary btn-icon"><i
                class="icon-base bx bx-search icon-md"></i></button>
          </div>
        </div>
        ...
        <div class="row gy-6 mb-6">
            ...
            <div class="card p-2 h-100 shadow-none border">
              <div class="rounded-2 text-center mb-4">
                <a href="{{ url('app/academy/course-details') }}"><img class="img-fluid"
                    src="{{ asset('assets/img/pages/app-academy-tutor-1.png') }}" alt="tutor image 1" /></a>
              </div>
              <div class="card-body p-4 pt-2">
                <div class="d-flex justify-content-between align-items-center mb-4">
                  ...
                  <p class="d-flex align-items-center justify-content-center fw-medium gap-1 mb-0">
                    4.4 <span class="text-warning"><i class="icon-base bx bxs-star me-1 mb-1_5"></i></span><span
                ...
                <div
                  ...
                  <a class="w-100 btn btn-label-primary d-flex align-items-center"
                    ...
                    <span class="me-2">Continue</span><i
                      class="icon-base bx bx-chevron-right icon-sm lh-1 scaleX-n1-rtl"></i> </a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-lg-4">
            <div class="card p-2 h-100 shadow-none border">
              <div class="rounded-2 text-center mb-4">
                <a href="{{ url('app/academy/course-details') }}"><img class="img-fluid"
                    src="{{ asset('assets/img/pages/app-academy-tutor-2.png') }}" alt="tutor image 2" /></a>
              </div>
              <div class="card-body p-4 pt-2">
                <div class="d-flex justify-content-between align-items-center mb-4 pe-xl-4 pe-xxl-0">
                  ...
                  <p class="d-flex align-items-center justify-content-center fw-medium gap-1 mb-0">
                    4.2 <span class="text-warning"><i class="icon-base bx bxs-star me-1 mb-1_5"></i></span><span
                      class="fw-normal"> (424)</span>
                  </p>
                </div>
                ...
                <div
                  class="d-flex flex-column flex-md-row gap-4 text-nowrap flex-wrap flex-md-nowrap flex-lg-wrap flex-xxl-nowrap">
                  <a class="w-100 btn btn-label-secondary d-flex align-items-center"
                    href="{{ url('app/academy/course-details') }}"> <i
                      class="icon-base bx bx-rotate-right icon-sm align-middle me-2"></i><span>Start Over</span> </a>
                  <a class="w-100 btn btn-label-primary d-flex align-items-center"
                    href="{{ url('app/academy/course-details') }}"> <span class="me-2">Continue</span><i
                      class="icon-base bx bx-chevron-right icon-sm lh-1 scaleX-n1-rtl"></i> </a>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card p-2 h-100 shadow-none border">
              <div class="rounded-2 text-center mb-4">
                <a href="{{ url('app/academy/course-details') }}"><img class="img-fluid"
                    src="{{ asset('assets/img/pages/app-academy-tutor-3.png') }}" alt="tutor image 3" /></a>
              </div>
              <div class="card-body p-4 pt-2">
                <div class="d-flex justify-content-between align-items-center mb-4">
                  <span class="badge bg-label-success">SEO</span>
                  <p class="d-flex align-items-center justify-content-center fw-medium gap-1 mb-0">
                    5 <span class="text-warning"><i class="icon-base bx bxs-star me-1 mb-1_5"></i></span><span
                      class="fw-normal"> (12)</span>
                  </p>
                </div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card p-2 h-100 shadow-none border">
              <div class="rounded-2 text-center mb-4">
                <a href="{{ url('app/academy/course-details') }}"><img class="img-fluid"
                    src="{{ asset('assets/img/pages/app-academy-tutor-4.png') }}" alt="tutor image 4" /></a>
              </div>
              <div class="card-body p-4 pt-2">
                <div class="d-flex justify-content-between align-items-center mb-4">
                  <span class="badge bg-label-info">Music</span>
                  <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                    3.8 <span class="text-warning"><i class="icon-base bx bxs-star me-1 mb-1_5"></i></span><span
                      class="fw-normal"> (634)</span>
                  </p>
                </div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card p-2 h-100 shadow-none border">
              <div class="rounded-2 text-center mb-4">
                <a href="{{ url('app/academy/course-details') }}"><img class="img-fluid"
                    src="{{ asset('assets/img/pages/app-academy-tutor-5.png') }}" alt="tutor image 5" /></a>
              </div>
              <div class="card-body p-4 pt-2">
                <div class="d-flex justify-content-between align-items-center mb-4">
                  <span class="badge bg-label-warning">Painting</span>
                  <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                    4.7 <span class="text-warning"><i class="icon-base bx bxs-star me-1 mb-1_5"></i></span><span
                      class="fw-normal"> (34)</span>
                  </p>
                </div>
                ...
                <p class="d-flex align-items-center text-success mb-1"><i
                    class="icon-base bx bx-check me-1"></i>Completed</p>
                <div class="progress mb-4" style="height: 8px">
                  <div class="progress-bar w-100" role="progressbar" aria-valuenow="25" aria-valuemin="0"
                    aria-valuemax="100"></div>
                </div>
                <a class="w-100 btn btn-label-primary" href="{{ url('app/academy/course-details') }}"><i
                    class="icon-base bx bx-rotate-right icon-sm me-1_5"></i>Start Over</a>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-lg-4">
            <div class="card p-2 h-100 shadow-none border">
              <div class="rounded-2 text-center mb-4">
                <a href="{{ url('app/academy/course-details') }}"><img class="img-fluid"
                    src="{{ asset('assets/img/pages/app-academy-tutor-6.png') }}" alt="tutor image 6" /></a>
              </div>
              <div class="card-body p-4 pt-2">
                <div class="d-flex justify-content-between align-items-center mb-4">
                  <span class="badge bg-label-danger">UI/UX</span>
                  <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                    3.6 <span class="text-warning"><i class="icon-base bx bxs-star me-1 mb-1_5"></i></span><span
                      class="fw-normal"> (2.5k)</span>
                  </p>
                </div>
        ...
        <nav aria-label="Page navigation" class="d-flex align-items-center justify-content-center">
          <ul class="pagination mb-0 pagination-rounded">
            ...
            <li class="page-item next">
              <a class="page-link" href="javascript:void(0);"><i
                  class="icon-base bx bx-chevron-right icon-sm scaleX-n1-rtl"></i></a>
            </li>
          ...
          <div class="card-body d-flex justify-content-between flex-wrap-reverse">
            <div
              ...
              <div class="card-title">
                ...
                <p class="text-body w-sm-80 app-academy-xl-100">Get the right professional certificate program for you.
                </p>
              </div>
          ...
          <div class="card-body d-flex justify-content-between flex-wrap-reverse">
            <div
              ...
              <div class="card-title">
                ...
                <p class="text-body app-academy-sm-60 app-academy-xl-100">Enroll now in the most popular and best rated
                  courses.</p>
              </div>
    ...
    <div class="card">
      <div class="card-body row gy-6">
        <div class="col-sm-12 col-lg-4 text-center pt-md-12 px-4">
          ...
          <p class="card-text">We offers 284 Free Online courses from top tutors and companies to help you start or
            advance your career skills. Learn online for free and fast today!</p>
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card h-100 shadow-none border">
            ...
            <div class="card-body">
              ...
              <p class="card-text">In the same way as any other artistic domain, singing lends itself perfectly to
                self-teaching.</p>
            </div>
          </div>
        </div>
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card h-100 shadow-none border">
            ...
            <div class="card-body">
              ...
              <p class="card-text">The Fender Acoustic Guitar is the best choice for both beginners and professionals
                offering a great sound.</p>
            </div>
          </div>
        </div>
      </div>
