        ...
        <div class="card-body">
          <div class="row row-gap-4 row-gap-xl-0">
            ...
            <div class="col-12 order-2 order-xl-0 d-flex flex-wrap row-gap-4">
              <button class="btn btn-primary me-4" data-bs-toggle="modal" data-bs-target="#upgradePlanModal">Upgrade
                Plan</button>
        ...
        <div class="card-header align-items-center">
          ...
          <div class="card-action-element">
            <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="modal"
              data-bs-target="#addNewCCModal"><i class="icon-base bx bx-plus icon-xs me-1_5"></i>Add Card</button>
          </div>
        </div>
        <div class="card-body">
          <div class="added-cards">
            ...
            <div class="cardMaster border p-6 rounded mb-4">
              <div class="d-flex justify-content-between flex-sm-row flex-column">
                <div class="card-information">
                  <img class="mb-2" src="{{ asset('assets/img/icons/payments/visa.png') }}" alt="Master Card"
                    height="25">
            ...
            <div class="cardMaster border p-6 rounded">
              <div class="d-flex justify-content-between flex-sm-row flex-column">
                <div class="card-information">
                  <img class="mb-2" src="{{ asset('assets/img/icons/payments/american-express-logo.png') }}"
                    alt="Visa Card" height="25">
                  <div class="d-flex align-items-center mb-2">
        ...
        <div class="card-header align-items-center flex-wrap gap-2">
          ...
          <div class="card-action-element">
            <button class="btn btn-primary btn-sm edit-address" type="button" data-bs-toggle="modal"
              data-bs-target="#addNewAddress"><i class="icon-base bx bx-plus icon-xs me-1_5"></i>Edit address</button>
          </div>
        </div>
        <div class="card-body">
          <div class="row">
