      ...
      <div class="nav-align-top">
        <ul class="nav nav-pills flex-column flex-md-row mb-6 flex-wrap row-gap-2">
          <li class="nav-item"> <a class="nav-link" href="{{ url('app/user/view/account') }}"><i
                class="icon-base bx bx-user me-1_5 icon-sm"></i>Account</a> </li>
          <li class="nav-item"> <a class="nav-link active" href="javascript:void(0);"><i
                class="icon-base bx bx-lock-alt me-1_5 icon-sm"></i>Security</a> </li>
          <li class="nav-item"> <a class="nav-link" href="{{ url('app/user/view/billing') }}"><i
                class="icon-base bx bx-detail me-1_5 icon-sm"></i>Billing & Plans</a> </li>
          <li class="nav-item"> <a class="nav-link" href="{{ url('app/user/view/notifications') }}"><i
                class="icon-base bx bx-bell me-1_5 icon-sm"></i>Notifications</a> </li>
          <li class="nav-item"> <a class="nav-link" href="{{ url('app/user/view/connections') }}"><i
                class="icon-base bx bx-link me-1_5 icon-sm"></i>Connections</a> </li>
        </ul>
      </div>
      <!--/ User Pills -->
        ...
        <div class="card-body pt-0">
          ...
          <div class="mb-4">
            <div class="d-flex w-100 action-icons">
              ...
              <a href="javascript:;" class="btn btn-icon text-secondary" data-bs-target="#enableOTP"
                data-bs-toggle="modal"><i class="icon-base bx bx-edit icon-md"></i></a>
              <a href="javascript:;" class="btn btn-icon text-secondary"><i
                  class="icon-base bx bx-user-plus icon-md"></i></a>
            </div>
          </div>
          <p class="mb-0">
      ...
      <div class="card mb-6">
        ...
        <div class="table-responsive table-border-bottom-0">
          <table class="table">
            ...
            <tbody>
              <tr>
                <td class="text-truncate"><i class="icon-base bx bxl-windows icon-md text-info me-4"></i> <span
              ...
              <tr>
                <td class="text-truncate"><i class="icon-base bx bx-mobile-alt icon-md text-danger me-4"></i> <span
              ...
              <tr>
                <td class="text-truncate"><i class="icon-base bx bxl-android icon-md text-success me-4"></i> <span
              ...
              <tr>
                <td class="text-truncate"><i class="icon-base bx bxl-apple icon-md text-secondary me-4"></i> <span
