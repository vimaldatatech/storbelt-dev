...
@section('content')
        ...
        <ul class="list-inline mb-0">
          ...
          <li class="list-inline-item">
            <a href="javascript:void(0);" class="card-reload"><i
                class="icon-base bx bx-rotate-left scaleX-n1-rtl"></i></a>
          </li>
          <li class="list-inline-item">
  ...
  <p>Use <code>.card-action</code> class with <code>.card</code> class to create action card. Use
    <code>.card-action-title</code> for action card title and <code>.card-action-element</code> to warp the actions icons.
  </p>
  <div class="row mb-12 gx-6">
      ...
      <div class="card card-action mb-6">
        ...
        <div class="collapse show">
          <div class="card-body pt-0">
            <p class="card-text">To create a collapsible card, use <code>.card-collapsible</code> class with action item.
              To show the collapsible content default use <code>.show</code> class with <code>.collapse</code>.</p>
    ...
    <div class="col-md">
      <div class="card card-action mb-6">
        ...
        <div class="card-body">
          <p class="card-text">To create a card with refresh action, use <code>.card-reload</code> class with action item.
            Use <code>.card-alert</code> class to show custom response message.</p>
          <p class="card-text">Click on <i class="icon-base bx bx-rotate-left scaleX-n1-rtl"></i> icon to see refresh card
            content in action.</p>
        </div>
      </div>
    </div>
        ...
        <div class="card-header header-elements">
          ...
          <div class="card-header-elements ms-auto">
            <button type="button" class="btn btn-xs btn-primary"><span
                class="icon-base bx bx-plus icon-xs me-1"></span>Button</button>
          </div>
        </div>
        <div class="card-body">
