    ...
    <div class="col-md-12">
      <div class="nav-align-top">
        <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
          <li class="nav-item">
            <a class="nav-link" href="{{ url('pages/profile-user') }}"><i class="icon-base bx bx-user me-1_5 icon-sm"></i>
              Profile</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="javascript:void(0);"><i class="icon-base bx bx-group me-1_5 icon-sm"></i>
              Teams</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('pages/profile-projects') }}"><i
                class="icon-base bx bx-grid-alt me-1_5 icon-sm"></i>
              Projects</a>
          </li>
          <li class="nav-item">
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        <div class="card-body">
          ...
          <p class="mb-3 pb-1">We don’t make assumptions about the rest of your technology stack, so you can develop new
            features...</p>
            ...
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                ...
                <li class="avatar avatar-sm">
                  <span class="avatar-initial rounded-circle pull-up" data-bs-toggle="tooltip" data-bs-placement="top"
                    title="9 more">+9</span>
                </li>
              </ul>
            </div>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        <div class="card-body">
          ...
          <p class="mb-3 pb-1">The development of Vue and its ecosystem is guided by an international team, some of whom
            have chosen.</p>
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                ...
                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Alan Walker"
                  class="avatar avatar-sm pull-up">
                  <img class="rounded-circle" src="{{ asset('assets/img/avatars/6.png') }}" alt="Avatar" />
                </li>
                <li class="avatar avatar-sm">
                  <span class="avatar-initial rounded-circle pull-up" data-bs-toggle="tooltip" data-bs-placement="top"
                    title="14 more">+4</span>
                </li>
              </ul>
            </div>
            <div class="ms-auto">
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        <div class="card-body">
          ...
          <p class="mb-3 pb-1">A design or product team is more than just the people on it. A team includes the people,
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        <div class="card-body">
          ...
          <p class="mb-3 pb-1">Support your team. Your customer support team is fielding the good, the bad, and the ugly
            day in out.</p>
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        <div class="card-body">
          ...
          <p class="mb-3 pb-1">Digital marketing refers to advertising delivered through digital channels such as search
            engines, websites…</p>
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        <div class="card-body">
          ...
          <p class="mb-3 pb-1">Event is defined as a particular contest which is part of a program of contests. An
            example of an event is...</p>
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        <div class="card-body">
          ...
          <p class="mb-3 pb-1">Explore, install, use, and remix thousands of plugins and files published to the Figma
            Community by designers.</p>
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                ...
                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Micky Ressula"
                  class="avatar avatar-sm pull-up">
                  <img class="rounded-circle" src="{{ asset('assets/img/avatars/1.png') }}" alt="Avatar" />
                </li>
              </ul>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        <div class="card-body">
          ...
          <p class="mb-3 pb-1">React Native lets you create truly native apps and doesn't compromise your users'
            experiences....</p>
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
