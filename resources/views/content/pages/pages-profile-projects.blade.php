    ...
    <div class="col-md-12">
      <div class="nav-align-top">
        <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="javascript:void(0);"><i class="icon-base bx bx-grid-alt icon-sm me-1_5"></i>
              Projects</a>
          </li>
          <li class="nav-item">
          ...
          <div class="d-flex align-items-start">
            <div class="d-flex align-items-center">
              ...
              <div class="me-2">
                ...
                <div class="client-info text-body"><span class="fw-medium">Client: </span><span>Christian Jimenez</span>
                </div>
              </div>
            </div>
            <div class="ms-auto">
          ...
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 z-2">
                ...
                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                  title="Julee Rossignol" class="avatar avatar-sm pull-up me-3">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i
                  class="icon-base bx bx-chat me-1"></i> 15</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card h-100">
          ...
          <div class="d-flex align-items-start">
            <div class="d-flex align-items-center">
              ...
              <div class="me-2">
                ...
                <div class="client-info text-body"><span class="fw-medium">Client: </span><span>Jeffrey Phillips</span>
                </div>
              </div>
            </div>
            <div class="ms-auto">
        ...
        <div class="card-body border-top">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i
                  class="icon-base bx bx-chat me-2"></i> 236</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card h-100">
          ...
          <div class="d-flex align-items-start">
            <div class="d-flex align-items-center">
              ...
              <div class="me-2">
                ...
                <div class="client-info text-body"><span class="fw-medium">Client: </span><span>Ricky McDonald</span>
                </div>
              </div>
            </div>
            <div class="ms-auto">
        ...
        <div class="card-body border-top">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i
                  class="icon-base bx bx-chat me-1"></i> 98</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card h-100">
          ...
          <div class="d-flex align-items-start">
            <div class="d-flex align-items-center">
              ...
              <div class="me-2">
                ...
                <div class="client-info text-body"><span class="fw-medium">Client: </span><span>Hulda Wright</span>
                </div>
              </div>
            </div>
            <div class="ms-auto">
        ...
        <div class="card-body border-top">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i
                  class="icon-base bx bx-chat me-1"></i> 120</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card h-100">
          ...
          <div class="d-flex align-items-start">
            <div class="d-flex align-items-center">
              ...
              <div class="me-2">
                ...
                <div class="client-info text-body"><span class="fw-medium">Client: </span><span>Jerry Greene</span>
                </div>
              </div>
            </div>
            <div class="ms-auto">
        ...
        <div class="card-body border-top">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i
                  class="icon-base bx bx-chat me-1"></i> 20</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
          ...
          <div class="d-flex align-items-start">
            <div class="d-flex align-items-center">
              ...
              <div class="me-2">
                ...
                <div class="client-info text-body"><span class="fw-medium">Client: </span><span>Olive Strickland</span>
                </div>
              </div>
            </div>
            <div class="ms-auto">
        ...
        <div class="card-body border-top">
          ...
          <div class="progress mb-4 rounded" style="height: 8px;">
            <div class="progress-bar rounded" role="progressbar" style="width: 100%;" aria-valuenow="100"
              aria-valuemin="0" aria-valuemax="100"></div>
          </div>
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i
                  class="icon-base bx bx-chat me-1"></i> 37</a>
            </div>
          </div>
        </div>
      </div>
