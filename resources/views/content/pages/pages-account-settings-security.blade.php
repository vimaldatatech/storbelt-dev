    ...
    <div class="col-md-12">
      ...
      <div class="card mb-6">
        <div class="card-body">
          ...
          <p class="mb-6">An API key is a simple encrypted string that identifies an application without any principal.
            They are useful for accessing public data anonymously, and are used to associate API requests with your
            ...
            <tbody>
              <tr>
                <td class="text-truncate text-heading fw-medium"><i
                    class="icon-base bx bxl-windows icon-md align-top text-info me-4"></i>Chrome on Windows</td>
              ...
              <tr>
                <td class="text-truncate text-heading fw-medium"><i
                    class="icon-base bx bxl-android  icon-md align-top text-success me-4"></i>Chrome on iPhone</td>
              ...
              <tr>
                <td class="text-truncate text-heading fw-medium"><i
                    class="icon-base bx bxl-apple icon-md align-top text-secondary me-4"></i>Chrome on Android</td>
              ...
              <tr>
                <td class="text-truncate text-heading fw-medium"><i
                    class="icon-base bx bx-mobile-alt icon-md align-top text-danger me-4"></i>Chrome on MacOS</td>
              ...
              <tr>
                <td class="text-truncate text-heading fw-medium"><i
                    class="icon-base bx bxl-apple icon-md align-top text-warning me-4"></i>Chrome on Windows</td>
                <td class="text-truncate">HP Spectre 360</td>
                <td class="text-truncate">Switzerland</td>
              ...
              <tr class="border-transparent">
                <td class="text-truncate text-heading fw-medium"><i
                    class="icon-base bx bxl-android icon-md align-top text-success me-4"></i>Chrome on Android</td>
                <td class="text-truncate">Oneplus 9 Pro</td>
                <td class="text-truncate">Dubai</td>
