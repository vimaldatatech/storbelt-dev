...
@section('vendor-script')
  @vite(['resources/assets/vendor/libs/cleave-zen/cleave-zen.js', 'resources/assets/vendor/libs/select2/select2.js'])
@endsection
                        ...
                        <div class="mb-4">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <span class="input-group-text cursor-pointer" id="collapsible-payment-cvv2"><i
                                class="icon-base bx bx-help-circle" data-bs-toggle="tooltip" data-bs-placement="top"
