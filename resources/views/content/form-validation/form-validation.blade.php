          ...
          <form id="formValidationExamples" class="row g-6">
            ...
            <div class="col-md-6 form-control-validation">
              ...
              <select class="selectpicker hobbies-select w-100" id="formValidationHobbies" data-style="btn-default"
                data-icon-base="icon-base bx" data-tick-icon="bx-check text-primary" name="formValidationHobbies"
                multiple>
            ...
            <div class="col-12 form-control-validation">
              <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" id="formValidationSwitch" name="formValidationSwitch"
                  required />
