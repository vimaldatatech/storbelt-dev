    ...
    !function(t, e) {
      ...
      return function() {
        var t = { 9698: function(t2, e2, n2) {
          ...
          const _s = class _s extends r2.EmbedBlot {
            static value() {
            }
            constructor(t3, e3, n3) {
              super(t3, e3), this.selection = n3, this.textNode = document.createTextNode(_s.CONTENTS), this.domNode.appendChild(this.textNode), this.savedLength = 0;
            }
            detach() {
            ...
            format(t3, e3) {
              ...
              null != n3 && (this.savedLength = _s.CONTENTS.length, n3.optimize(), n3.formatAt(i2, _s.CONTENTS.length, t3, e3), this.savedLength = 0);
            }
            index(t3, e3) {
            ...
            restore() {
              ...
              const e3 = this.prev instanceof i.A ? this.prev : null, n3 = e3 ? e3.length() : 0, r3 = this.next instanceof i.A ? this.next : null, o = r3 ? r3.text : "", { textNode: l } = this, a = l.data.split(_s.CONTENTS).join("");
              let c;
              if (l.data = _s.CONTENTS, e3) c = e3, (a || r3) && (e3.insertAt(e3.length(), a + o), r3 && r3.remove());
            ...
            optimize(t3) {
              ...
              for (; e3; ) {
                if ("A" === e3.domNode.tagName) {
                  this.savedLength = _s.CONTENTS.length, e3.isolate(this.offset(e3), this.length()).unwrap(), this.savedLength = 0;
                  break;
                }
                e3 = e3.parent;
              }
          ...
          const _o = class _o extends r2.InlineBlot {
            static compare(t3, e3) {
              const n3 = _o.order.indexOf(t3), r3 = _o.order.indexOf(e3);
              return n3 >= 0 || r3 >= 0 ? n3 - r3 : t3 === e3 ? 0 : t3 < e3 ? -1 : 1;
            }
            formatAt(t3, e3, n3, i2) {
              if (_o.compare(this.statics.blotName, n3) < 0 && this.scroll.query(n3, r2.Scope.BLOT)) {
                const r3 = this.isolate(t3, e3);
                i2 && r3.wrap(n3, i2);
              } else super.formatAt(t3, e3, n3, i2);
            }
            optimize(t3) {
              if (super.optimize(t3), this.parent instanceof _o && _o.compare(this.statics.blotName, this.parent.statics.blotName) > 0) {
                const t4 = this.parent.isolate(this.offset(), this.length());
                this.moveChildren(t4), t4.wrap(this);
              }
            }
          };
          __publicField(_o, "allowedChildren", [_o, i.A, r2.EmbedBlot, s.A]);
          ...
          class m extends u.ScrollBlot {
            ...
            deltaToRenderBlocks(t3) {
              ...
              return t3.forEach((t4) => {
                const r3 = t4 == null ? void 0 : t4.insert;
          ...
          __publicField(m, "blotName", "scroll");
          __publicField(m, "className", "ql-editor");
          __publicField(m, "tagName", "DIV");
          __publicField(m, "defaultChild", i.Ay);
          __publicField(m, "allowedChildren", [i.Ay, i.zo, o.A]);
          function b(t3, e3, n3) {
            n3.reduce((e4, n4) => {
          ...
          class N extends x.A {
            constructor(t3, e3) {
              ...
              this.quill.on(r2.Ay.events.EDITOR_CHANGE, (t4, e4, n3, i2) => {
          ...
          __publicField(N, "DEFAULTS", { delay: 1e3, maxStack: 100, userOnly: false });
          function E(t3, e3) {
            let n3 = e3;
            ...
            constructor(t3, e3) {
              super(t3, e3), t3.root.addEventListener("drop", (e4) => {
                ...
                if (r3) {
                  ...
                  ((_a = e4.dataTransfer) == null ? void 0 : _a.files) && this.upload(n4, e4.dataTransfer.files);
                }
              });
            }
            upload(t3, e3) {
              ...
              Array.from(e3).forEach((t4) => {
                var _a;
                t4 && ((_a = this.options.mimetypes) == null ? void 0 : _a.includes(t4.type)) && n3.push(t4);
          ...
          class S extends x.A {
            ...
            handleBeforeInput(t3) {
              ...
              const n3 = function(t4) {
                var _a;
                return "string" == typeof t4.data ? t4.data : ((_a = t4.dataTransfer) == null ? void 0 : _a.types.includes("text/plain")) ? t4.dataTransfer.getData("text/plain") : null;
              }(t3);
              if (null == n3) return;
          ...
          }, __publicField(_a, "events", { EDITOR_CHANGE: "editor-change", SCROLL_BEFORE_UPDATE: "scroll-before-update", SCROLL_BLOT_MOUNT: "scroll-blot-mount", SCROLL_BLOT_UNMOUNT: "scroll-blot-unmount", SCROLL_OPTIMIZE: "scroll-optimize", SCROLL_UPDATE: "scroll-update", SCROLL_EMBED_UPDATE: "scroll-embed-update", SELECTION_CHANGE: "selection-change", TEXT_CHANGE: "text-change", COMPOSITION_BEFORE_START: "composition-before-start", COMPOSITION_START: "composition-start", COMPOSITION_BEFORE_END: "composition-before-end", COMPOSITION_END: "composition-end" }), __publicField(_a, "sources", { API: "api", SILENT: "silent", USER: "user" }), _a);
        }, 7356: function(t2, e2) {
          "use strict";
          ...
          var x = class {
            ...
            isBlank() {
              ...
              if ((t3 == null ? void 0 : t3.statics.blotName) !== c.Ay.blotName) return false;
              const e3 = t3;
          ...
          const _I = class _I {
            ...
            constructor(t3) {
              ...
              if (this.options = function(t4, e4) {
                ...
                const s3 = !e4.theme || e4.theme === _I.DEFAULTS.theme ? L.A : _I.import(`themes/${e4.theme}`);
                if (!s3) throw new Error(`Invalid theme ${e4.theme}. Did you register it?`);
                const { modules: o2, ...l3 } = _I.DEFAULTS, { modules: a2, ...c2 } = s3.DEFAULTS;
                let u2 = M(e4.modules);
            ...
            insertEmbed(t3, e3, n3) {
              let r3 = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : _I.sources.API;
            ...
            scrollRectIntoView(t3) {
              ((t4, e3) => {
                ...
                let r3 = e3, i2 = t4;
                for (; i2; ) {
                  const t5 = i2 === n3.body, e4 = t5 ? { top: 0, right: ((_a = window.visualViewport) == null ? void 0 : _a.width) ?? n3.documentElement.clientWidth, bottom: ((_b = window.visualViewport) == null ? void 0 : _b.height) ?? n3.documentElement.clientHeight, left: 0 } : S(i2), o2 = getComputedStyle(i2), l2 = T(r3.left, r3.right, e4.left, e4.right, O(o2.scrollPaddingLeft), O(o2.scrollPaddingRight)), a2 = T(r3.top, r3.bottom, e4.top, e4.bottom, O(o2.scrollPaddingTop), O(o2.scrollPaddingBottom));
                  if (l2 || a2) if (t5) (_c = n3.defaultView) == null ? void 0 : _c.scrollBy(l2, a2);
                  else {
            ...
            setSelection(t3, e3, n3) {
              null == t3 ? this.selection.setRange(null, e3 || _I.sources.API) : ([t3, e3, , n3] = P(t3, e3, n3), this.selection.setRange(new f.Q(Math.max(0, t3), e3), n3), n3 !== N.A.sources.SILENT && this.scrollSelectionIntoView());
            }
            setText(t3) {
              let e3 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : N.A.sources.API;
          ...
          __publicField(_I, "DEFAULTS", { bounds: null, modules: { clipboard: true, keyboard: true, history: true, uploader: true }, placeholder: "", readOnly: false, registry: R, theme: "default" });
          __publicField(_I, "events", N.A.events);
          __publicField(_I, "sources", N.A.sources);
          __publicField(_I, "version", "2.0.3");
          __publicField(_I, "imports", { delta: o(), parchment: i, "core/module": q.A, "core/theme": L.A });
          let I = _I;
          function B(t3) {
...
${(0, l.X)(this.code(t3, e3))}
          ...
          const y = /font-weight:\s*normal/, v = ["P", "OL", "UL"], A = (t3) => t3 && v.includes(t3.tagName), x = /\bmso-list:[^;]*ignore/i, N = /\bmso-list:[^;]*\bl(\d+)/i, E = /\bmso-list:[^;]*\blevel(\d+)/i, w = [function(t3) {
            "urn:schemas-microsoft-com:office:word" === t3.documentElement.getAttribute("xmlns:w") && ((t4) => {
              ...
              e3.forEach((t5) => {
                ...
                var _a2;
                return (_a2 = t5.parentNode) == null ? void 0 : _a2.removeChild(t5);
              });
              const i2 = t4.documentElement.innerHTML, s2 = r3.map((t5) => ((t6, e4) => {
                const n4 = t6.getAttribute("style"), r4 = n4 == null ? void 0 : n4.match(N);
                if (!r4) return null;
                const i3 = Number(r4[1]), s3 = n4 == null ? void 0 : n4.match(E), o2 = s3 ? Number(s3[1]) : 1, l2 = new RegExp(`@list l${i3}:level${o2}\\s*\\{[^\\}]*mso-level-number-format:\\s*([\\w-]+)`, "i"), a2 = e4.match(l2);
                return { id: i3, indent: o2, type: a2 && "bullet" === a2[1] ? "bullet" : "ordered", element: t6 };
              })(t5, i2)).filter((t5) => t5);
              for (; s2.length; ) {
                const t5 = [];
                let e4 = s2.shift();
                for (; e4; ) t5.push(e4), e4 = s2.length && ((_a = s2[0]) == null ? void 0 : _a.element) === e4.element.nextElementSibling && s2[0].id === e4.id ? s2.shift() : null;
                ...
                const r4 = (_b = t5[0]) == null ? void 0 : _b.element, { parentNode: i3 } = r4 ?? {};
                r4 && (i3 == null ? void 0 : i3.replaceChild(n4, r4)), t5.slice(1).forEach((t6) => {
                  let { element: e5 } = t6;
                  i3 == null ? void 0 : i3.removeChild(e5);
                });
              }
            })(t3);
          }, function(t3) {
            t3.querySelector('[id^="docs-internal-guid-"]') && (((t4) => {
              Array.from(t4.querySelectorAll('b[style*="font-weight"]')).filter((t5) => {
                var _a;
                return (_a = t5.getAttribute("style")) == null ? void 0 : _a.match(y);
              }).forEach((e3) => {
                var _a;
                const n3 = t4.createDocumentFragment();
                n3.append(...e3.childNodes), (_a = e3.parentNode) == null ? void 0 : _a.replaceChild(n3, e3);
              });
            })(t3), ((t4) => {
              Array.from(t4.querySelectorAll("br")).filter((t5) => A(t5.previousElementSibling) && A(t5.nextElementSibling)).forEach((t5) => {
                var _a;
                (_a = t5.parentNode) == null ? void 0 : _a.removeChild(t5);
              });
            })(t3));
          }];
          const q = (0, l.A)("quill:clipboard"), k = [[Node.TEXT_NODE, function(t3, e3, n3) {
            var _a;
            let r3 = t3.data;
            if ("O:P" === ((_a = t3.parentElement) == null ? void 0 : _a.tagName)) return e3.insert(r3.trim());
            if (!R(t3)) {
            ...
            return "italic" === i2.fontStyle && (r3.italic = true), "underline" === i2.textDecoration && (r3.underline = true), "line-through" === i2.textDecoration && (r3.strike = true), (((_a = i2.fontWeight) == null ? void 0 : _a.startsWith("bold")) || parseInt(i2.fontWeight, 10) >= 700) && (r3.bold = true), e3 = Object.entries(r3).reduce((t4, e4) => {
              let [r4, i3] = e4;
            ...
            var _a, _b;
            const r3 = "TABLE" === ((_a = t3.parentElement) == null ? void 0 : _a.tagName) ? t3.parentElement : (_b = t3.parentElement) == null ? void 0 : _b.parentElement;
          ...
          class S extends a.A {
            ...
            onCaptureCopy(t3) {
              ...
              (_a = t3.clipboardData) == null ? void 0 : _a.setData("text/plain", i2), (_b = t3.clipboardData) == null ? void 0 : _b.setData("text/html", r3), e3 && (0, b.Xo)({ range: n3, quill: this.quill });
            }
            normalizeURIList(t3) {
              return t3.split(/\r?\n/).filter((t4) => "#" !== t4[0]).join("\n");
            }
            onCapturePaste(t3) {
              ...
              if (null == e3) return;
              const n3 = (_a = t3.clipboardData) == null ? void 0 : _a.getData("text/html");
              let r3 = (_b = t3.clipboardData) == null ? void 0 : _b.getData("text/plain");
              if (!n3 && !r3) {
                const e4 = (_c = t3.clipboardData) == null ? void 0 : _c.getData("text/uri-list");
                e4 && (r3 = this.normalizeURIList(e4));
              }
              const i2 = Array.from(((_d = t3.clipboardData) == null ? void 0 : _d.files) || []);
              if (!n3 && i2.length > 0) this.quill.uploader.upload(e3, i2);
              else {
                if (n3 && i2.length > 0) {
                  const t4 = new DOMParser().parseFromString(n3, "text/html");
                  if (1 === t4.body.childElementCount && "IMG" === ((_e = t4.body.firstElementChild) == null ? void 0 : _e.tagName)) return void this.quill.uploader.upload(e3, i2);
                }
          ...
          __publicField(S, "DEFAULTS", { matchers: [] });
        ...
        return function() {
          ...
          __publicField(c, "blotName", "blockquote");
          __publicField(c, "tagName", "blockquote");
          var u = c;
          ...
          __publicField(h, "blotName", "header");
          __publicField(h, "tagName", ["H1", "H2", "H3", "H4", "H5", "H6"]);
          ...
          __publicField(N, "blotName", "bold");
          __publicField(N, "tagName", ["STRONG", "B"]);
          var E = N;
          class w extends x.A {
            static create(t3) {
              const e3 = super.create(t3);
          ...
          __publicField(w, "blotName", "link");
          __publicField(w, "tagName", "A");
          __publicField(w, "SANITIZED_URL", "about:blank");
          __publicField(w, "PROTOCOL_WHITELIST", ["http", "https", "mailto", "tel", "sms"]);
          function q(t3, e3) {
          ...
          __publicField(k, "blotName", "script");
          __publicField(k, "tagName", ["SUB", "SUP"]);
          var _ = k;
          class L extends x.A {
          }
          __publicField(L, "blotName", "underline");
          __publicField(L, "tagName", "U");
          var S = L, O = n(746);
          class T extends O.A {
            static create(t3) {
          ...
          __publicField(T, "blotName", "formula");
          __publicField(T, "className", "ql-formula");
          __publicField(T, "tagName", "SPAN");
          var j = T;
          ...
          __publicField(R, "blotName", "image");
          __publicField(R, "tagName", "IMG");
          var I = R;
          ...
          __publicField(M, "blotName", "video");
          __publicField(M, "className", "ql-video");
          __publicField(M, "tagName", "IFRAME");
...
${(0, V.X)(this.code(t3, e3))}
          ...
          const _J = class _J extends a.Ay {
            ...
            format(t3, e3) {
              t3 === _J.blotName && e3 ? this.domNode.setAttribute("data-row", e3) : super.format(t3, e3);
            }
            row() {
              return this.parent;
            }
          ...
          __publicField(Y, "blotName", "table-row");
          __publicField(Y, "tagName", "TR");
          ...
          class ot extends F.A {
            constructor(t3, e3) {
              ...
              if (super(t3, e3), Array.isArray(this.options.container)) {
                ...
                }(e4, this.options.container), (_b2 = (_a2 = t3.container) == null ? void 0 : _a2.parentNode) == null ? void 0 : _b2.insertBefore(e4, t3.container), this.container = e4;
              ...
              this.container instanceof HTMLElement ? (this.container.classList.add("ql-toolbar"), this.controls = [], this.handlers = {}, this.options.handlers && Object.keys(this.options.handlers).forEach((t4) => {
                var _a3;
                const e4 = (_a3 = this.options.handlers) == null ? void 0 : _a3[t4];
